...
function field(x, i) {
  ...
  } else if (Caml_obj.caml_obj_tag(f) === Obj.string_tag) {
    return Curry._1(Printf.sprintf(/* Format */[
  ...
  } else if (Caml_obj.caml_obj_tag(f) === Obj.double_tag) {
...
function to_string(x) {
  ...
  while(true) {
    ...
    } else if (Caml_obj.caml_obj_tag(x) !== 0) {
      return x[0];
    } else {
